#ifndef DDMD_RANDOM_WAVES_H
#define DDMD_RANDOM_WAVES_H
...
namespace DdMd
{
   ...
   /**
   * RandomWaves evaluates structure factors in Fourier space.
   *
   ...
   *
   * \sa \ref ddMd_analyzer_RandomWaves_page "param file format"
   * 
   * \ingroup DdMd_Analyzer_Module
   */
   class RandomWaves : public Analyzer
   {
   ...
   public:
      ...
      */
      RandomWaves(Simulation& simulation);
      ...
      */
      ...
      /**
      * Add particles to RandomWaves accumulators.
      *
   ...
   protected:
      ...
      */
      std::normal_distribution<double>  gussianDistribution_(1.0,1.0);
      ...
      */
      ...
      /// Number of wavevectors.
      Average  accumulatorU_;

      /// Number of wavevectors.
      Average  accumulatorN_;
