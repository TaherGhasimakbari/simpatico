#ifndef DDMD_COLLECTIVE_VARIABLE_H
#define DDMD_COLLECTIVE_VARIABLE_H
...
namespace DdMd
{
   ...
   /**
   * CollectiveVariable evaluates structure factors in Fourier space.
   *
   ...
   * CollectiveVariable{
   *    interval                      1000
   *    outputFileName    CollectiveVariable
   *    nMode                            1
   *    modes                     1      1
   *                              0     -1
   *    nWave                            5
   ...
   *
   * \sa \ref ddMd_analyzer_CollectiveVariable_page "param file format"
   * 
   ...
   */
   ...
   public:
      ...
      */
      CollectiveVariable(Simulation& simulation);
      ...
      */
      ...
      /**
      * Add particles to CollectiveVariable accumulators.
      *
   ...
   protected:
      ...
      */
      DArray<double> CollectiveVariables_;
      ...
      */
      DArray< std::complex<double> >  fourier_;
      ...
      * First index is wavevector, second is atom type.
      */
      DArray< std::complex<double> >  totalFourier_;
