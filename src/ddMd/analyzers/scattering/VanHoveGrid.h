#ifndef DDMD_VAN_HOVE_GRID_H
#define DDMD_VAN_HOVE_GRID_H
...
namespace DdMd
{
   ...
   * 
   * \sa \ref ddMd_analyzer_VanHoveGrid_page "param file format"
   *
   * \ingroup DdMd_Analyzer_Module
   */
   class VanHoveGrid : public StructureFactor
   {
   public:
      ...
      */
      VanHoveGrid(Simulation &simulation);
      ...
      */
      ...
      /**
      * Add particle pairs to VanHoveGrid histogram.
      *
